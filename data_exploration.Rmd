...
#experiment with pivot_wider
resp_clean<- all_responses %>% 
  pivot_wider(id_cols = respondent_id, names_from = element_label, values_from = original_content) # I think the previous method will actually be easier
